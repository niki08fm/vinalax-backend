...
// Middleware rules
// Replace app.use(cors()); with this configuration:
app.use(cors({
  origin: "http://localhost:5173", // Explicitly allows your Vite React frontend access
  credentials: true,
...
// SETUP ACCOUNT ROUTE (One-time call to seed initial encrypted login details)
...
// ── 5. START ACTIVE ENGINE LISTENER ──
const PORT = process.env.PORT || 5001;
app.listen(PORT, () => console.log(`🚀 Vinalax JWT-Core Server running perfectly on port ${PORT}`));